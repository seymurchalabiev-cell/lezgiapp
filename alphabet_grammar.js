...
const ALPHABET = [
  {up:'А',  lo:'а',  sound:'a',                   special:false, words:['атун','ам','абур']},
  {up:'Б',  lo:'б',  sound:'b',                   special:false, words:['буба','ктаб']},
  {up:'В',  lo:'в',  sound:'v',                   special:false, words:['вун','вах','вацI','вад']},
  {up:'Г',  lo:'г',  sound:'g',                   special:false, words:['гада','гьава']},
  {up:'Гъ', lo:'гъ', sound:'ʁ (гортанный г)',     special:true,  words:['гъил','рагъ','дагъ']},
  {up:'Гь', lo:'гь', sound:'h (придыхательный)',  special:true,  words:['гьава','жегьил']},
  {up:'Д',  lo:'д',  sound:'d',                   special:false, words:['диде','дагъ']},
  {up:'Е',  lo:'е',  sound:'ye/e',                special:false, words:[]},
  {up:'Ж',  lo:'ж',  sound:'ж',                   special:false, words:['жегьил']},
  {up:'З',  lo:'з',  sound:'z',                   special:false, words:['зун']},
  {up:'И',  lo:'и',  sound:'i',                   special:false, words:['ирид','ктаб']},
  {up:'Й',  lo:'й',  sound:'j',                   special:false, words:['йикъ','йиф']},
  {up:'К',  lo:'к',  sound:'k',                   special:false, words:['кас','кар','ктаб']},
  {up:'КI', lo:'кI', sound:"k' (абруптив)",       special:true,  words:['кIвал','кIам','кIелун','кIуьд']},
  {up:'Къ', lo:'къ', sound:'q (увулярный)',        special:true,  words:['кьвед','кьуд','кьил','йикъ']},
  {up:'Кь', lo:'кь', sound:"q' (фарингализ.)",    special:true,  words:['кьвед']},
  {up:'Л',  lo:'л',  sound:'l',                   special:false, words:[]},
  {up:'М',  lo:'м',  sound:'m',                   special:false, words:['муьжуьд']},
  {up:'Н',  lo:'н',  sound:'n',                   special:false, words:[]},
  {up:'О',  lo:'о',  sound:'o',                   special:false, words:[]},
  {up:'П',  lo:'п',  sound:'p',                   special:false, words:['пуд']},
  {up:'ПI', lo:'пI', sound:"p' (абруптив)",       special:true,  words:[]},
  {up:'Р',  lo:'р',  sound:'r',                   special:false, words:['рагъ','руш','ругуд']},
  {up:'С',  lo:'с',  sound:'s',                   special:false, words:['сад','стха']},
  {up:'Т',  lo:'т',  sound:'t',                   special:false, words:['вахт']},
  {up:'ТI', lo:'тI', sound:"t' (абруптив)",       special:true,  words:['стIал']},
  {up:'У',  lo:'у',  sound:'u',                   special:false, words:['ругуд']},
  {up:'Уь', lo:'уь', sound:'ü (передний)',        special:true,  words:['куьн','хуьр','муьжуьд']},
  {up:'Ф',  lo:'ф',  sound:'f',                   special:false, words:['фин']},
  {up:'Х',  lo:'х',  sound:'x (задн. х)',         special:false, words:['хва','хъсан']},
  {up:'Хъ', lo:'хъ', sound:'χ (увулярный х)',     special:true,  words:['хъсан']},
  {up:'Хь', lo:'хь', sound:'ħ (фарингальный)',    special:true,  words:['хьуьл']},
  {up:'Ц',  lo:'ц',  sound:'ts',                  special:false, words:['цав','цIуд']},
  {up:'ЦI', lo:'цI', sound:"ts' (абруптив)",      special:true,  words:['цIуд','цIай','цIифе']},
  {up:'Ч',  lo:'ч',  sound:'tʃ',                  special:false, words:['ччар','чун']},
  {up:'ЧI', lo:'чI', sound:"tʃ' (абруптив)",      special:true,  words:['чIехи']},
  {up:'Ш',  lo:'ш',  sound:'ʃ',                   special:false, words:['шегьер']},
  {up:'Щ',  lo:'щ',  sound:'ʃtʃ',                 special:false, words:[]},
  {up:'Ъ',  lo:'ъ',  sound:'(смягчение/сигнал)',  special:false, words:['йикъ']},
  {up:'Ы',  lo:'ы',  sound:'ы',                   special:false, words:[]},
  {up:'Ь',  lo:'ь',  sound:'(мягкий знак)',       special:false, words:[]},
  {up:'Э',  lo:'э',  sound:'e',                   special:false, words:[]},
  {up:'Ю',  lo:'ю',  sound:'yu',                  special:false, words:[]},
  {up:'Я',  lo:'я',  sound:'ya',                  special:false, words:[]}
];
